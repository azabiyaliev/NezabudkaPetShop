...
import './UserForm.css'
import ConsentAgreementFull from "../../ConsentAgreement/ConsentAgreementFull.tsx";
...
const RegisterUser = () => {
  ...
  return (
    <Box>
      {showConsentStep ? (
        <ConsentAgreementFull onConfirm={submitHandler} back={() => setShowConsentStep(false)} />
      ) : (
        <Box
          display="flex"
        ...
        >
          ...
          >
            <Box>
              ...
              />
              <Typography variant="h4" marginBottom={SPACING.xs}>
                Добро пожаловать
              </Typography>
              <Typography>
